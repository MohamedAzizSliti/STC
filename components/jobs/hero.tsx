...
export function JobsHero() {
  return (
    <section className="relative overflow-hidden bg-stc-green text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-16 lg:px-8 lg:py-24">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-4 max-w-2xl text-lg text-white/80 leading-relaxed text-pretty">
            Build your professional profile and get discovered by leading companies across multiple industries.
          </p>
          <Button size="lg" className="mt-8 bg-white text-stc-green hover:bg-white/90 gap-2">
            Create Your Profile
